...
resolutionMap = {"800": (1280, 800), "720": (1280, 720), "400": (640, 400), "480": (640, 480)}
...
res = (
    ...
    if resolution[1] == 400
    else dai.MonoCameraProperties.SensorResolution.THE_480_P
)
...
stereo.setRectifyEdgeFillColor(255)  # Black, to better see the cutout
